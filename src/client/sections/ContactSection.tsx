...
export function ContactSection({
  ...
  return (
    <section
      id="contact"
      data-tone={surface}
      className="wedding-section pt-8 pb-28 md:pt-10 md:pb-36 px-4 relative overflow-x-clip"
    >
              ...
              <div className="flex gap-4 justify-center md:justify-end">
                ...
                {hasFacebook && (
                  ...
                  >
                    <svg
                      viewBox="0 0 24 24"
                      className="w-10 h-10 fill-[#1877F2] transition-transform duration-300 group-hover:scale-110 select-none pointer-events-none"
                    >
                ...
                {hasInstagram && (
                  ...
                  >
                    <svg
                      viewBox="0 0 24 24"
                      className="w-10 h-10 transition-transform duration-300 group-hover:scale-110 select-none pointer-events-none"
                    >
                      <defs>
                        <linearGradient
                          id="instagram-grad"
                ...
                {hasTikTok && (
                  ...
                  >
                    <div className="relative w-10 h-10 flex items-center justify-center select-none pointer-events-none">
                      ...
                      <svg
                        viewBox="0 0 24 24"
                        className="absolute w-10 h-10 fill-[#25F4EE] opacity-90"
                        style={{ transform: "translate(-0.75px, -0.75px)" }}
                      >
                      ...
                      <svg
                        viewBox="0 0 24 24"
                        className="absolute w-10 h-10 fill-[#FE2C55] opacity-90"
                        style={{ transform: "translate(0.75px, 0.75px)" }}
                      >
                        <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.97-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.92-1.31 1.83-3.58 2.81-5.78 2.45-2.2-.36-4.11-1.9-4.82-4.01-.78-2.32-.2-4.97 1.47-6.71 1.35-1.4 3.39-2.07 5.3-1.77V12.1c-1-.22-2.08.04-2.89.67-.86.67-1.32 1.76-1.25 2.85.06 1.1.75 2.11 1.77 2.53 1.01.41 2.22.21 3.03-.48.45-.38.71-.93.77-1.5.07-1.35.03-2.7.04-4.05.01-4.07-.01-8.15.02-12.22z" />
                      </svg>
                      ...
                      <svg
                        viewBox="0 0 24 24"
                        className="absolute w-10 h-10 fill-black transition-transform duration-300 group-hover:scale-110"
                      >
                        <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.97-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.92-1.31 1.83-3.58 2.81-5.78 2.45-2.2-.36-4.11-1.9-4.82-4.01-.78-2.32-.2-4.97 1.47-6.71 1.35-1.4 3.39-2.07 5.3-1.77V12.1c-1-.22-2.08.04-2.89.67-.86.67-1.32 1.76-1.25 2.85.06 1.1.75 2.11 1.77 2.53 1.01.41 2.22.21 3.03-.48.45-.38.71-.93.77-1.5.07-1.35.03-2.7.04-4.05.01-4.07-.01-8.15.02-12.22z" />
                      </svg>
                    </div>
