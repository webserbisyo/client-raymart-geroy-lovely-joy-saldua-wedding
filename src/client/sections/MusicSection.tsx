      ...
      <div className="max-w-md mx-auto relative z-10">
        <div className="relative overflow-visible">
          ...
          >
            ...
            {/* Disc Graphic */}
            <div className="relative w-28 h-28 mx-auto mb-8 flex items-center justify-center z-20">
            ...
            {/* Controls */}
            <div className="relative z-20 flex justify-center gap-3 items-center">
          ...
          {/* Diagonal floral pair: top-left + bottom-right */}
          <WeddingDecoration
            family="frame-corner"
            orientation="left"
            position="top-left"
            ...
            className="wedding-decoration--target-music"
          />
          <WeddingDecoration
            family="card-edge"
            orientation="right"
